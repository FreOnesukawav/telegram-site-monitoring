...
func load_list() {
  data,
  err: = ioutil.ReadFile(configFile)
  if err != nil {
...
func main() {
  bot,
  err: = tgbotapi.NewBotAPI(telegramBotToken)
  if err != nil {
    log.Panic(err)
  }
